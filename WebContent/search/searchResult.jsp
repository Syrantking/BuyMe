...
<body>
	...
	try {
			...
			String statusv= request.getParameter("status1");
			
			//query 
			String str = "Select maker, type, model,auction_id,min_price from Auction Join Items using(item_id) WHERE (maker ='" + makerv + "') OR (type ='" + typev + "') OR (model ='" + modelv + "') OR (min_price <= '" + pricev + "') OR (auction_id = '" + auctionidv + "') or (status ='" + statusv + "');";
