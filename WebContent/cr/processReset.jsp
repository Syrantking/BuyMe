...
<body>
	...
	try
	{
		String password = "UPDATE Users SET password ='" + request.getParameter("password") + "' WHERE username ='" + request.getParameter("username") +"'";
        stmt.executeUpdate(password);
		response.sendRedirect("resetPasswords.jsp");		
	}		
